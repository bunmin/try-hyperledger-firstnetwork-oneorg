...
const caCertPath = path.resolve(__dirname, '..', 'first-network', 'crypto-config', 'peerOrganizations', 'org2.example.com', 'ca', 'ca.org2.example.com-cert.pem');
...
async function main() {
    try {
        ...
        console.log(getBackSigValueHex);
        return;
