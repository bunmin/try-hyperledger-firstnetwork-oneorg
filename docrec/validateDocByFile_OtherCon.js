...
// const caCertPath = path.resolve(__dirname, '..', 'first-network', 'crypto-config', 'peerOrganizations', 'org1.example.com', 'ca', 'ca.org1.example.com-cert.pem');
const caCertPath = path.resolve(__dirname, '..', 'first-network', 'crypto-config', 'peerOrganizations', 'org1.example.com', 'ca', 'ca.org1.example.com-cert.pem');
...
async function main() {
    try {
        ...
        // var getBackSigValueHex = new Buffer("MEQCIC4ugJmWoOMSV2fP4J95omiSlA8SIp3XcyzopUQWDMYnAiAJFSUAEgSUgbqRsQ9tDlzNdhOBeqLOGsCt32DhTtl5BQ==", 'base64').toString('hex');
